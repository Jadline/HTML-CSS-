...
function Cart(){
    const {cartitems,setCartitems,showmodal,setshowmodal}  = useContext(cartContext);
    ...
    return(
        ...
        <div className={styles.cartContainer}>
            ...
            {cartitems.length > 0 ? <div className={styles.cartdata}>
